    ...
    protected function render()
    {
        ...
        <div class="categories-shortlist--container">
               <div class="categories-shortlist--header">
                  ...
                  <a '.top10apps_get_that_link($settings['blink']).' class="categories-shortlist--all-link categories-shortlist--all-link__header">'.$settings['btext'].'</a>
               </div>
                ...
                if ($settings['list']) {
                    foreach ($settings['list'] as $scroll) {
                        echo '<li class="categories-shortlist--category">
                                 <a class="categories-shortlist--category__link" '.top10apps_get_that_link($scroll['link']).'>
                                 '.top10apps_get_that_image($scroll['img'], 'categories-shortlist--category__icon').'

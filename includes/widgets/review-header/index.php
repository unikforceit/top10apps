           ...
           <div class="reviews-infomartion">
               <div class="visitor-review-agg reviews-infomartion__card reviews-infomartion__stars">
                  <div class="visitor-review-agg__overview">
                     ...
                     <span class="visitor-review-agg__count show-modal"><a class="review-link" ' . get_that_link($settings['rlink']) . '><span>' . $settings['review_counts'] . '</span></a></span>
                  </div>
               </div>
            ...
            <div class="widgets-bar">
               <div class="by-author">
                  <div class="by-author__author-credentials">
                      ' . get_that_image($settings['img'], 'by-author__image') . '
                     <div class="by-author__author-metadata">
                        <div class="by-author__author-name"><a ' . get_that_link($settings['link']) . ' class="by-author__author">' . $settings['name'] . '</a></div>
        ...
        echo '</ul>
           ...
           <div class="product-cta-button">
                <div class="product-cta-button-icon">
                     ' . get_that_image($settings['cta_img'], 'product-cta-button-icon-image') . '
                </div>
                <div class="product-cta-button-text">' . $settings['cta_text'] . '</div>
                    <a ' . get_that_link($settings['cta_link']) . ' class="cta-button"><span class="cta-button__text"> ' . $settings['cta_btn'] . '</span></a>
            </div>
        </section>
        <div class="product-sidebar-sticky">
   <div class="product-sidebar-sticky__container">
      <div class="product-sidebar-sticky__left">
       ' . get_that_image($settings['stk_img'], 'product-sidebar-sticky__left__logo product-sidebar-sticky__left__logo--show-user-reviews') . '
      ...
      <div class="product-sidebar-sticky__right"><a class="cta-button" ' . get_that_link($settings['stk_link']) . ' > <span class="cta-button__text">' . $settings['cta_btn'] . '</span></a></div>
   </div>
</div>

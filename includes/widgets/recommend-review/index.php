    ...
    protected function render()
    {
        ...
        <div class="related-reviews__container">
           <div class="related-reviews__header">
              ...
              <a class="related-reviews__header__show-more" '.get_that_link($settings['blink']).'>'.$settings['btext'].'</a>
           </div>
        ...
        if ($settings['list']) {
            foreach ($settings['list'] as $scroll) {
                echo '<div class="related-reviews__item">
                 ...
                 '.get_that_image($scroll['img'], 'related-reviews__item__logo__image').'
                 </div>
                 <div class="related-reviews__item__text">'.$scroll['item'].'</div>
                 <div class="related-reviews__item__buttons">
                    <div class="related-reviews__item__buttons-container"><a '.get_that_link($scroll['vlink']).' class="related-reviews__item__buttons-visit-button nilink">'.$scroll['visit'].'</a></div>
                    <div class="related-reviews__item__buttons-container"><a '.get_that_link($scroll['rlink']).' class="related-reviews__item__buttons-review-button cta-button">'.$scroll['read'].'</a></div>
                 </div>
              </div>';
            }
        }
